                    ...
                    <div class="col-md-12 col-lg-8 mb-5">
                        <div class="p-5 bg-white">
                            ...
                            <!-- <div class="text-center mb-4">
                                <img src="../images/person.jpg" alt="Profile Picture" class="img-fluid rounded-circle" style="width: 150px; height: 150px; object-fit: cover;">
                            </div> -->
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    <p class="font-weight-bold mb-1">Company:</p>
                                    <p>Sample Company Inc.</p>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    <p class="font-weight-bold mb-1">Started:</p>
                                    <p>June 2014</p>
                                </div>
                                <div class="col-md-6 mb-2">
                                    <p class="font-weight-bold mb-1">Ended"</p>
                                    <p>March 2025</p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    <p class="font-weight-bold mb-1">Permanent Address:</p>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    <p class="font-weight-bold mb-1">Preferred Job:</p>
