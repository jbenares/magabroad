<template>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container-fluid px-md-4">
			<!-- Logo section -->
			<a class="navbar-brand  !flex !space-x-2" href="index.html">
                ...
                <div class="testimony-wrap py-4">
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img bg-[url('../images/person_1.jpg')]"></div>
                    	<div class="pl-3">
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img bg-[url('../images/person_2.jpg')]"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img bg-[url('../images/person_3.jpg')]"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img bg-[url('../images/person_4.jpg')]"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img bg-[url('../images/person_5.jpg')]"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
        		...
        		<div class="carousel-candidates owl-carousel">
        			<div class="item">
		        		<a href="#" class="team text-center">
		        			<div class="img bg-[url('../images/person_1.jpg')]"></div>
		        			<h2>Danica Lewis</h2>
        			...
        			<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img bg-[url('../images/person_2.jpg')]"></div>
		        			<h2>Nicole Simon</h2>
		        			<span class="position">Western City, UK</span>
		        		</a>
	        		</div>
	        		<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img bg-[url('../images/person_3.jpg')]"></div>
		        			<h2>Cloe Meyer</h2>
		        			<span class="position">Western City, UK</span>
		        		</a>
	        		</div>
	        		<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img bg-[url('../images/person_4.jpg')]"></div>
	        		...
	        		<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img bg-[url('../images/person_5.jpg')]"></div>
		        			<h2>Dave Buff</h2>
		        			<span class="position">Western City, UK</span>
		        		</a>
	        		</div>
	        		<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img bg-[url('../images/person_6.jpg')]"></div>
		        			<h2>Dave Buff</h2>
		        			<span class="position">Western City, UK</span>
		        		</a>
	        		</div>
        ...
        <div class="row d-flex">
          <div class="col-md-3 d-flex ">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 bg-[url('../images/image_1.jpg')]">
              </a>
              <div class="text mt-3">
              	<div class="meta mb-2">
          ...
          <div class="col-md-3 d-flex ">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 bg-[url('../images/image_2.jpg')]">
              </a>
              <div class="text mt-3">
              	<div class="meta mb-2">
                  <div><a href="#">August 28, 2019</a></div>
          ...
          <div class="col-md-3 d-flex ">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 bg-[url('../images/image_3.jpg')]">
              </a>
              <div class="text mt-3">
              	<div class="meta mb-2">
                  <div><a href="#">August 28, 2019</a></div>
          ...
          <div class="col-md-3 d-flex ">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 bg-[url('../images/image_4.jpg')]">
              </a>
              <div class="text mt-3">
              	<div class="meta mb-2">
                  <div><a href="#">August 28, 2019</a></div>
